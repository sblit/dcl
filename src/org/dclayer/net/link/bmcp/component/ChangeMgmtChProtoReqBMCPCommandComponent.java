 ...
 */
public class ChangeMgmtChProtoReqBMCPCommandComponent extends BMCPCommandComponent {
	...
	public String toString() {
		return String.format("ChangeMgmtChProtoReq(protocol=%s)", protocol);
	}
	...
	@Override
	public byte getType() {
		return BMCPCommandComponent.CHANGE_MGMTCHANNEL_PROTOCOL_REQUEST;
	}
