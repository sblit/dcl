...
public class GroupMemberLLARequestInterserviceMessage extends InterserviceMessage {
	...
	public int getTypeId() {
		return InterservicePacket.GROUP_MEMBER_LLA_REQUEST;
	}

	@Override
	public void callOnReceiveMethod(InterserviceChannel interserviceChannel) {
		interserviceChannel.onReceiveGroupMemberLLARequestInterserviceMessage(this);
	}
