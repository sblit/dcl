...
/**
 * a pong redirect message of revision 0 of the service-to-service protocol
 */
public class PongRedirectMessage extends Rev0Message {
	/**
	 * the {@link ServiceAddressComponent} contained in this {@link PongRedirectMessage}
	 */
	private ServiceAddressComponent toAddress;
	/**
	 * the {@link DataComponent} contained in this {@link PongRedirectMessage}
	 */
	 ...
	 */
	public PongRedirectMessage(ByteBuf byteBuf) throws ParseException, BufException {
		super(byteBuf);
	}
	 ...
	 */
	public PongRedirectMessage(ServiceAddressComponent toAddress, DataComponent data) {
