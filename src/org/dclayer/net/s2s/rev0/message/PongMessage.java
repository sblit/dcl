...
/**
 * a pong message of revision 0 of the service-to-service protocol
 */
public class PongMessage extends Rev0Message {
	/**
	 * the {@link DataComponent} contained in this {@link PongMessage}
	 */
	 ...
	 */
	public PongMessage(ByteBuf byteBuf) throws ParseException, BufException {
		super(byteBuf);
	}
	 ...
	 */
	public PongMessage(DataComponent data) {
		this.data = data;
	}
	
	/**
	 * @return the {@link DataComponent} contained in this {@link PongMessage}
	 */
